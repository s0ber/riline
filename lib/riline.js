(function() {
  var INDENTATION, LINES_AROUND, LINE_BREAK, Riline, colors, _;
  ...
  Riline = (function() {
    function _Class(text, highlightLines) {
      this.highlightLines = highlightLines != null ? highlightLines : true;
      this.text = text;
      this.messages = [];
    }
    ...
    _Class.prototype.printMessage = function(message) {
      var end, i, line, lineNumber, lineText, messageText, start, _i;
      ...
      for (i = _i = start; start <= end ? _i <= end : _i >= end; i = start <= end ? ++_i : --_i) {
        ...
        lineText += line;
        if (this.highlightLines && i >= message.startLine && i <= message.endLine) {
